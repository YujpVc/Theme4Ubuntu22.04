...
const DockPosition = {BOTTOM: 'bottom',LEFT: 'left',RIGHT: 'right',TOP: 'top'};
const Vector = Me.imports.vector.Vector;

const { DockItemDotsOverlay, DockItemBadgeOverlay, DockItemContainer, DockBackground } = Me.imports.dockItems;
const { Bounce, Linear } = Me.imports.effects.easing;
const { get_distance_sqr, get_distance, isInRect, isOverlapRect, tempPath } = Me.imports.utils;
